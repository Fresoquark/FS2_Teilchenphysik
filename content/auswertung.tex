...
\end{figure}
Zu sehen ist hier ein kontinuierlich es Spektrum mit ansteigender Anzahl der Events zu h\"oheren Massen f\"ur beide Diagramme. Die minimale Masse ist hier die doppelte Kaon Masse und die Obergrenze haben wir hier bei $\SI{3.5}{\giga\electronvolt}$ gew\"ahlt, da uns h\"oherliegende Resonanzen einerseits nicht interessieren und andererseits irrelevant f\"ur diese Analyse sind, da das B-Meson welches hier untersucht wird selbst nur eine Masse von $\SI{5279.32}{\mega\electronvolt}$ besitzt und aus den Diagrammen nur Charme-Resonanzen hervorkommen sollen.
